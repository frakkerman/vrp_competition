...
def main(instance):
    ...
    # students should implement logic to generate the solution, so it is not enough to just provide the solution
...
# NOTE: comment out all the below lines before submission, this code is only useful for locally running your,
